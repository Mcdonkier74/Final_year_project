...
class Policy_Gradient(BasicLearningAgent):
    ...
    def __init__(self, env, i_id, f_min_time=3600, f_gamma=0.99, f_k=0.8,
            lr=0.05,
            gamma=0.8,
            state_size=4,
            action_size=2,
            ...
            """
            super(Policy_Gradient, self).__init__(env=env,
                                                  i_id=i_id,
                                                  f_min_time=f_min_time,
                                                  f_gamma=f_gamma)
            self.f_k=f_k
            ...
            self.s_agent_name = 'Policy_Gradient'
...
class Learning_Policy_Gradient(Policy_Gradient):
    '''
    ...
    def __init__(self, env, i_id, f_min_time=3600., f_gamma=0.99, f_k=0.8):
        ...
        # default color
        super(Learning_Policy_Gradient, self).__init__(env=env,
                                            i_id=i_id,
                                            f_min_time=f_min_time,
                                            f_gamma=f_gamma,
                                            f_k=f_k)
        # Initialize any additional variables here
        self.s_agent_name = 'Policy Gradient'
...
def run(s_option):
    ...
    """
#    for i in range(0,15):
    i_idx = 1  # 15  # index of the start file to be used in simulations
    ...
    #s_fname = 'data/Book1.zip'
    #s_fname = 'data/OneDrive-2018-03-07.zip'
